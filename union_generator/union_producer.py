...
class UnionProducer:
    def __init__(self):
        ...
        protobuf_serializer = ProtobufSerializer(
            union_pb2.Union, schema_registry_client, {"use.deprecated.format": True}
        )
    ...
    def produce_to_topic(self, union: Union):
        self.producer.produce(
            topic=TOPIC, partition=-1, key=str(union.corporateName), value=union, on_delivery=self.delivery_report
        )
